    ...
    protected function handleApiEndpoints($slug)
    {
        switch ($slug) {
            ...
            case 'applications':
                ...
                break;
            case 'exchanges':
                $exchanges = DB::connection('mysql')->table('available_buying_options')->select('available_buying_options.title', 'available_buying_options.link')->where(array('type' => 'exchange-platforms'))->get()->sortBy('order_id')->toArray();
