                ...
                if (elementToBind.length) {
                                    ...
                                    success: function (response) {
                                        if (response.success) {
                                            if (parseInt(response.data) > 0) {
                                                ...
                                                if ($('.notifications-link').length) {
                                                    $('.notifications-link').html('<img src="https://account.dentacoin.com/assets/uploads/notifications.png" alt="Notification icon"/>');
                                                }

                                                if ($('.header-avatar').length) {
                                                    if ($('.header-avatar .header-avatar-notifications-counter').length) {
                                                        $('.header-avatar .header-avatar-notifications-counter').remove();
                                                    }
                                                }
                                            }
                                        }
                    ...
                    async function showMiniHub() {
                        if (hasOwnProperty.call(params, 'without_apps') && params.without_apps) {
                            ...
                            var miniHubHtml = '<div class="dcn-hub-mini without-apps" id="dcn-hub-mini"><span class="up-arrow">▲</span><div class="hidden-box"><div class="hidden-box-footer">'+platformMenu+'<div class="hidden-box-wrapper"><div class="home-btn"><a href="'+platform_home_link+'"><img src="//dentacoin.com/assets/images/home-btn-dentacoin-hub.svg" alt="Home button"/></a></div><div class="logout-btn-parent"> <a href="'+params.log_out_link+'"><img src="//dentacoin.com/assets/images/power.png" style="width: 20px; vertical-align: middle" alt="Power button"/> Log out</a> </div> <div class="my-account-btn-parent"><a href="//account.dentacoin.com?platform='+params.platform+'" class="my-account-link">My Account</a></div></div></div></div></div>';
                                ...
                                if ($('#add-branches-popup-link').length) {
                                    ...
                                    if (branches != undefined) {
                                        ...
                                        for (var key of Object.keys(branches)) {
                                            branchesHtml += '<li class="' + (branches[key].notification ? 'notification' : '') + '"><a href="'+branches[key].url+'" target="_blank"><div class="img"><img src="'+branches[key].avatar+'" alt=""/></div><span class="text">'+branches[key].name+'</span></a></li>';
                                        }
                                        branchesHtml += '</ul></div>';
                                    }
                            ...
                            miniHubHtml += '<div class="hidden-box-footer"><div class="logout-btn-parent"><a href="'+params.log_out_link+'"><img src="//dentacoin.com/assets/images/power.png" alt="Power button" style="width: 20px; vertical-align: middle"/> Log out</a></div><div class="my-account-btn-parent"><a href="//account.dentacoin.com/notifications?platform='+params.platform+'" class="notifications-link inline-block"><img src="https://account.dentacoin.com/assets/uploads/notifications.png" alt="Notification icon"/></a><a href="//account.dentacoin.com?platform='+params.platform+'" class="my-account-link">My Account</a></div></div></div></div>';
